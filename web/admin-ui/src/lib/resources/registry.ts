...
const PAGES: PageMeta[] = [
  ...
  { key: "features", title: "功能开关", description: "开启或关闭任意游戏模块", group: "核心数据", icon: Zap },
  { key: "constants", title: "游戏常量", description: "等级、转世、背包等全局常量", group: "核心数据", icon: Database },
  { key: "cooldowns", title: "冷却时间", description: "各操作冷却时间配置", group: "核心数据", icon: Timer },
  { key: "realms", title: "境界配置", description: "境界需求、属性成长与寿元", group: "核心数据", icon: Sparkles },
  { key: "spiritual_roots", title: "灵根图鉴", description: "一千种灵根、稀有权重与完整加成", group: "核心数据", icon: Wand2 },
  ...
  { key: "sensitive_words", title: "敏感词管理", description: "增删改敏感词和替换规则", group: "内容审核", icon: ShieldAlert },
  ...
  { key: "puppets_config", title: "傀儡管理", description: "傀儡配置、材料、效果、条件和等级数据", group: "全新玩法", icon: Gamepad2 },
  { key: "secret_conflicts", title: "秘境争夺", description: "秘境配置、材料、效果、条件和等级数据", group: "全新玩法", icon: Gamepad2 },
  { key: "inheritances", title: "传承管理", description: "传承配置、材料、效果、条件和等级数据", group: "全新玩法", icon: BookOpen },
  { key: "dao_insights", title: "悟道管理", description: "悟道配置、材料、效果、条件和等级数据", group: "全新玩法", icon: Brain },
  { key: "battlefields", title: "仙魔战场", description: "战场配置、材料、效果、条件和等级数据", group: "全新玩法", icon: Sword },
  { key: "root_evolutions", title: "灵根进化", description: "灵根进化配置、材料、效果和条件", group: "全新玩法", icon: Wand2 },
  { key: "inner_demons", title: "渡劫心魔", description: "心魔配置、材料、效果和条件", group: "全新玩法", icon: Sparkles },
  { key: "couple_skills", title: "合体技管理", description: "合体技配置、材料、效果和条件", group: "全新玩法", icon: Heart },
  { key: "immortal_herbs", title: "仙药培育", description: "仙药配置、材料、效果和条件", group: "全新玩法", icon: FlaskConical },
  { key: "artifact_refinements", title: "法宝炼化", description: "炼化配置、材料、效果和条件", group: "全新玩法", icon: Gem },
  { key: "destiny_deductions", title: "天机推演", description: "推演配置、材料、效果和条件", group: "全新玩法", icon: Brain },
  { key: "leylines", title: "天地灵脉", description: "灵脉配置、材料、效果和条件", group: "全新玩法", icon: Globe2 },
  { key: "sect_wars", title: "宗门战争", description: "宗门战争配置、材料、效果和条件", group: "全新玩法", icon: Sword },
  { key: "immortal_encounters", title: "仙缘奇遇", description: "奇遇配置、材料、效果和条件", group: "全新玩法", icon: Sparkles },
  { key: "star_realms", title: "宇宙星河", description: "星河配置、材料、效果和条件", group: "全新玩法", icon: Star },
  { key: "menus", title: "菜单管理", description: "后台导航与群内游戏菜单，保存立即生效", group: "系统管理", icon: ListTree },
  { key: "status_display", title: "状态显示", description: "切换状态指令使用纯图片模式或完整文字模式", group: "系统管理", icon: Images },
  { key: "owner_settings", title: "主人设置", description: "设置唯一主人QQ开放平台用户ID", group: "系统管理", icon: Settings },
  { key: "managers", title: "管理设置", description: "管理员ID、名称、权限范围和启用状态", group: "系统管理", icon: Shield },
  { key: "server_status", title: "服务器状态", description: "CPU、内存、磁盘和运行时间", group: "系统监控", icon: Gauge, readonly: true },
  { key: "online_monitor", title: "在线监控", description: "最近五分钟实时活跃人数", group: "系统监控", icon: Activity, readonly: true },
  { key: "request_stats", title: "请求统计", description: "后台 API 请求和错误统计", group: "系统监控", icon: Webhook, readonly: true },
  { key: "slow_queries", title: "慢查询", description: "数据库慢 SQL 记录", group: "系统监控", icon: Timer, readonly: true },
  { key: "performance", title: "性能监控", description: "请求耗时和数据库连接状态", group: "系统监控", icon: Gauge, readonly: true },
  { key: "alerts", title: "告警配置", description: "CPU、内存、磁盘和延迟告警阈值", group: "系统监控", icon: ShieldAlert },
]
