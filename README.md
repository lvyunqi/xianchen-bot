...
本项目以 [GPL-3.0](LICENSE) 协议开源。原作者 随缘（suiyuan）<3694759812@qq.com>，维护者 夜空（mryunqi）<434658198@qq.com>。本程序为自由软件：你可以依据自由软件基金会发布的 GNU 通用公共许可证第 3 版重新发布或修改它；本程序不提供任何担保。
